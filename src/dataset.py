...
class CharCorruptionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        prefix = truncated_document[:masked_content_index]
        suffix = truncated_document[masked_content_index + masked_content_len:]
        masked_content = truncated_document[masked_content_index : masked_content_index + masked_content_len]
